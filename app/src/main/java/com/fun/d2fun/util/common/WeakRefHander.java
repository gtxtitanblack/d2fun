...
/**
 * Created by ZX on 15/7/13.
 * 使用弱引用的handler，防止出现内存泄露
 */
public class WeakRefHander {
     ...
     */
    public WeakRefHander(@Nullable Handler.Callback callback) {
     ...
     */
    public WeakRefHander(@NonNull Looper looper) {
        mCallback = null;
     ...
     * @param callback The callback interface in which to handle messages, or null.
     */
    public WeakRefHander(@NonNull Looper looper, @NonNull Handler.Callback callback) {
        mCallback = callback;
